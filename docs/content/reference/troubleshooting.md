...
Most of these come down to network reality or how orcid serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

orcid rate-limits like any public site. orcid already paces
...
Where a surface is gated, orcid reads a cookie or token you supply
...
`orcid`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what orcid actually did

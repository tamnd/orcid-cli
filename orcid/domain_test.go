...
// HTTP behaviour is covered in orcid_test.go.
...
func TestHostWiring(t *testing.T) {
	...
	if want := "orcid://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("orcid", "about")
	if err != nil || got.String() != "orcid://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want orcid://page/about", got.String(), err)
	}
}
